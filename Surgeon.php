...
<body class="sub_page">
  ...
  <div class=" bg-info mt-3 m-auto">
        <a href="Doctor.php" class="text-decoration-none text-white fs-6 fw-bold px-3">Doctor</a>
        <a href="Surgeon.php" class="text-decoration-none text-white fs-6 fw-bold px-4">Surgeon</a>
  </div>
      ...
      <div class="row">
          <?php
            ...
            while($row = mysqli_fetch_array($Record)){
              $check_page = $row['SecondaryCategory'];
              if($check_page === 'Surgeon'){
            echo "
            ...
            <h5>$row[name]</h5>
            <h5>$row[specialisation]</h5>
            <p class='rupee'>Rs: $row[fees]</p>
            <input type='hidden' name='name' value='$row[name]'>
            <input type='hidden' name='fees' value='$row[fees]'>
