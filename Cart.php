  ...
  <div class="container-fluid">
        <div class="row justify-content-around my-5 mx-5">
                    ...
                    <tbody>
                       ...
                       if(isset($_SESSION['cart'])){
                           foreach($_SESSION['cart'] as $key=> $value){
                            ...
                            <td><input type='number' name='PQuantity' class='text-center' value ='$value[productQuantity]'></td>
                            <td>Rs $pTotal</td>
            ...
            <div class="col-lg-3 text-center">
                ...
                <a href='payment.php' class='btn btn-dark border rounded-pill py-2 btn-block'>Procceed to checkout</a>
            </div>
        </div>
    </div>
